...
class ProductoShowPage extends StatefulWidget {
  final ProductoModel item;

  ProductoShowPage({required this.item});

  @override
  _ProductoShowPageState createState() => _ProductoShowPageState();
}

class _ProductoShowPageState extends State<ProductoShowPage> {
  @override
  void initState() {
    super.initState();
  }
